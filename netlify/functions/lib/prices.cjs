...
const PRICES = {
  'xl-vinile': { name: 'TROPPO LARGO Vinyl', price: 30, img: '/products/vinile.webp' },
  'xl-cd': { name: 'TROPPO LARGO CD Edition', price: 20, img: '/products/cd.webp' },
  'xl-maglietta': { name: 'YATP T-Shirt Bianca', price: 25, img: '/products/tshirt-front.webp' },
  'xl-felpa': { name: 'TROPPO LARGO - Hoodie', price: 40, img: '/products/hoodie-front.webp' },
};
